...
class StNet(nn.Module):
    def __init__(self, block, layers, cardinality = 32, num_classes = 400, T=7, N=5, input_channels = 3):
        super(StNet, self).__init__()
        self.inplanes = 64
        self.cardinality = cardinality
        self.T = T
        self.N = N
        self.conv1 = nn.Conv2d(input_channels*self.N, 64, kernel_size=7, stride=2, padding=3,
                               bias=False)
...
class TemporalBlock(nn.Module):
    def __init__(self, channels):
        ...
        self.conv1 = nn.Conv3d(channels, channels, kernel_size = (3,1,1),
