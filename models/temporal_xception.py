...
class TemporalXception(nn.Module):
    def __init__(self, in_channels, out_channels):
        ...
        self.sepconv1 = SeparableConv1d(in_channels, out_channels, kernel_size = 3, padding = 1)
        self.bn2 = nn.BatchNorm1d(out_channels)
        self.sepconv2 = SeparableConv1d(out_channels, out_channels, kernel_size = 3, padding = 1)
